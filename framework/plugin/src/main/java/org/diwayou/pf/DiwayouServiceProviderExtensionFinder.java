 ...
 */
public class DiwayouServiceProviderExtensionFinder extends AbstractExtensionFinder {

    private static final Logger log = LoggerFactory.getLogger(DiwayouServiceProviderExtensionFinder.class);

    public static final String EXTENSIONS_RESOURCE = "META-INF/diwayou";

    public DiwayouServiceProviderExtensionFinder(PluginManager pluginManager) {
        super(pluginManager);
    }
